# Retro Tetris Code of Conduct

## Our commitment

We are committed to a welcoming, harassment-free community for everyone, regardless of identity, background, experience, or ability.
...
This policy applies in repository spaces, project communications, community events, and public situations where someone is representing the project.

## Private reporting and enforcement

Report concerns privately through an established contact channel associated with the repository maintainers. Do not disclose incident details in a public issue or discussion. If no private route is known, ask a maintainer for a private contact method without describing the incident publicly.
